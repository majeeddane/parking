...
import { Menu, Car, Plus, ShieldCheck, QrCode, CheckCircle2, Clock } from 'lucide-react';
            ...
            <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-5 relative overflow-hidden">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-base text-[#123B5D]">Toyota Camry 2024</h3>
                    <span className="text-xs text-slate-400">سنة الصنع: 2024 · اللون: أبيض لؤلؤي</span>
                  </div>
                </div>

                <span className="bg-emerald-50 text-[#19A974] border border-emerald-200 text-xs px-3 py-1 rounded-full font-bold">
                  اشتراك مفعّل
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 bg-slate-50 p-4 rounded-2xl border border-slate-100 text-xs">
                ...
                <div>
                  ...
                  <span className="font-mono text-slate-700 font-bold" dir="ltr">2049182390</span>
                </div>
                <div>
              ...
              <div className="flex items-center justify-between pt-2 border-t border-slate-100">
                ...
                <span className="text-xs text-slate-400">المركبة الأساسية</span>
              </div>
            </div>
